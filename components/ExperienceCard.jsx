...
function PromptCard({ post, handleTagClick, handleEdit, handleDelete }) {
  ...
  return (
    <div className="prompt_card glassmorphism bg-black">
      <div className="flex flex-col justify-between items-start gap-5 w-full">
        <div className="  border border-[#6896F7] flex justify-between items-center gap-1 w-full cursor-pointer rounded-xl p-1">
          <Image
        ...
        {session?.user.id === post.creator._id && pathName === "/profile" && (
          <div className="mt-5 flex-center gap-4 border-t border_gray-400">
            <p
